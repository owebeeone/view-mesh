...
class CustomTitleBar(QWidget):
    ...
    def __init__(self, title: str, parent=None):
        ...
        # Optional: Create a small "folder" icon for the Explorer
...
class ViewMeshApp(QMainWindow):
    ...
    def setup_ui(self):
        ...
        custom_title = CustomTitleBar("Explorer", self.explorer_dock)
        ...
        self.explorer_dock.setFeatures(
            ...
            QDockWidget.DockWidgetFloatable  # Allow floating since we have a custom title bar
        )
        
        # Add a border and style to the dock widget
        ...
        # Apply additional widget-specific styling
    ...
    def apply_widget_styling(self):
        ...
        # Apply styles that need to be widget-specific
        additional_style = """
        QTabBar::tab {
            padding: 6px 12px;
            margin: 0px 2px;
        ...
        """
        self.setStyleSheet(additional_style)
...
def main():
    ...
    # Apply a consistent style to all widgets
    style = f"""
    QWidget {{
